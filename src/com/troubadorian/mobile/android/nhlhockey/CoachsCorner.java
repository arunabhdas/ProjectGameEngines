...
public class CoachsCorner extends ListActivity 
{
    ProgressDialog myProgress;

    public static final String TAG = "Coach's Corner";
    
    private static final String C2 = "Coach's Corner";
    ...
    public class RssLoadingTask extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            // TODO Auto-generated method stub
            myProgress = ProgressDialog.show(CoachsCorner.this,
...
/*        AppMeasurement s;
    ...
    private void readRss()
    {
        ...
        try
        {
                    ...
                    || (wifi == NetworkInfo.State.CONNECTED || wifi == NetworkInfo.State.CONNECTING))
            {
                ...
                URL rssUrl = new URL(
                        "http://cds1-feed.yospace.com/001111233626");
            ...
            {
                File file = new File(
                        "/sdcard/Android/data/hnic/files/coachscorner.xml");
    ...
    protected void launchNewsViewer()
    {
        ...
        Intent b = new Intent(this, CoachsCorner.class);
        startActivity(b);
    }
