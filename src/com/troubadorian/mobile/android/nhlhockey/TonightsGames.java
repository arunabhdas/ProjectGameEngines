...
public class TonightsGames extends ListActivity
{
    ProgressDialog myProgress;

    public static final String TAG = "Tonights Games";
    ...
    public class RssLoadingTask extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            // TODO Auto-generated method stub
            myProgress = ProgressDialog.show(TonightsGames.this,
    ...
    private void readRss()
    {
        ...
        try
        {
                    ...
                    || (wifi == NetworkInfo.State.CONNECTED || wifi == NetworkInfo.State.CONNECTING))
            {
                ...
                URL rssUrl = new URL(
                        "http://cds1-feed.yospace.com/001110786536");
                ...
                String fname = "tonightsgames.xml";
            ...
            {
                File file = new File(
                        "/sdcard/Android/data/hnic/files/tonightsgames.xml");
    ...
    protected void launchNewsViewer()
    {
        ...
        Intent b = new Intent(this, TonightsGames.class);
        startActivity(b);
    }
