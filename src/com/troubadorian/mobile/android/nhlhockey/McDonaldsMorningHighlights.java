...
public class McDonaldsMorningHighlights extends ListActivity 
{
    ProgressDialog myProgress;

    public static final String TAG = "Morning Highlights";
    
    private static final String C2 = "Morning Highlights";
    ...
    public class RssLoadingTask extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            // TODO Auto-generated method stub
            myProgress = ProgressDialog.show(McDonaldsMorningHighlights.this,
    ...
    private void readRss()
    {
        ...
        try
        {
                    ...
                    || (wifi == NetworkInfo.State.CONNECTED || wifi == NetworkInfo.State.CONNECTING))
            {
                ...
                URL rssUrl = new URL(
                        "http://cds1-feed.yospace.com/001110956001");
                ...
                String fname = "mcdonaldsmorninghighlights.xml";
            ...
            {
                File file = new File(
                        "/sdcard/Android/data/hnic/files/mcdonaldsmorninghighlights.xml");
    ...
    protected void launchNewsViewer()
    {
        ...
        Intent b = new Intent(this, McDonaldsMorningHighlights.class);
        startActivity(b);
    }
