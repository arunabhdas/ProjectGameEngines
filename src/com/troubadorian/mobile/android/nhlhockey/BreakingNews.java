...
public class BreakingNews extends ListActivity 
{
    ProgressDialog myProgress;

    public static final String TAG = "Breaking News";
    
    private static final String C2 = "Breaking News";
    ...
    public class RssLoadingTask extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            // TODO Auto-generated method stub
            myProgress = ProgressDialog.show(BreakingNews.this,
    ...
    private void readRss()
    {
        ...
        try
        {
                    ...
                    || (wifi == NetworkInfo.State.CONNECTED || wifi == NetworkInfo.State.CONNECTING))
            {
                ...
                URL rssUrl = new URL(
                        "http://cds1-feed.yospace.com/001110786488");
            ...
            {
                File file = new File(
                        "/sdcard/Android/data/hnic/files/breakingnews.xml");
...
/*            AppMeasurement s;
    ...
    protected void launchNewsViewer()
    {
        ...
        Intent b = new Intent(this, BreakingNews.class);
        startActivity(b);
    }
