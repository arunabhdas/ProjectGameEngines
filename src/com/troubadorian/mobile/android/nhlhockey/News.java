...
import com.troubadorian.mobile.android.nhlhockey.BreakingNews.MyCustomAdapter;
import com.troubadorian.mobile.android.nhlhockey.BreakingNews.RssLoadingTask;
...
public class News extends ListActivity 
{
    ...
    public class RssLoadingTask extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            // TODO Auto-generated method stub
            myProgress = ProgressDialog.show(News.this, "...retrieving...",
    ...
    public class MyCustomAdapter extends ArrayAdapter<RSSItemVideo>
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (row == null)
            {
                ...
                row = inflater.inflate(R.layout.row_news, parent, false);
            }
   ...
   /*     AppMeasurement s;
    ...
    private void readRss()
    {
        ...
        try
        {
                    ...
                    || (wifi == NetworkInfo.State.CONNECTED || wifi == NetworkInfo.State.CONNECTING))
            {
                ...
                /*URL rssUrl = new URL(
                        "http://www.cbc.ca/m/rss/sports-hockey.xml");*/
                ...
                String fname = "sports-hockey.xml";
            ...
            } else
            {
                ...
                /*File file = new File(
                        "/sdcard/Android/data/hnic/files/sports-hockey.xml");*/

                File file = new File("/data/data/com.troubadorian.mobile.android.nhlhockey/files/news.xml");
             ...
             * 
             * SAXParserFactory mySAXParserFactory = SAXParserFactory
             * .newInstance(); SAXParser mySAXParser =
             * mySAXParserFactory.newSAXParser(); XMLReader myXMLReader =
             * mySAXParser.getXMLReader(); RSSHandlerVideo myRSSHandlerVideo =
             * new RSSHandlerVideo();
             * myXMLReader.setContentHandler(myRSSHandlerVideo); InputSource
    ...
    private void displayRss()
    {
        if (myRssFeedVideo != null)
        {
            ...
            MyCustomAdapter adapter = new MyCustomAdapter(this,
                    R.layout.row_news, myRssFeedVideo.getList());
    ...
    protected void onListItemClick(ListView l, View v, int position, long id)
    {
        ...
        /*
         * playVideo("http://cds1.yospace.com/access/choice/u/0/1/15749276?rtspdirect=true&f=001110786488&stylesheet=mobile"
         * , true);
         */
                ...
                || (wifi == NetworkInfo.State.CONNECTED || wifi == NetworkInfo.State.CONNECTING))
        {
            ...
            i.setClass(News.this, NewsDetails.class);

            i.putExtra("uriString", myRssFeedVideo.getItem(position).getLink());
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        case R.id.home:
            /*launchHomeViewer(); */     
            Intent intenthome = new Intent(this, NHLHockey.class);
        ...
        case R.id.blogs:
            ...
            break; 
        case R.id.exit:
            Intent intent = new Intent(this, NHLHockey.class);
