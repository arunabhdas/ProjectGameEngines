...
public class InsideHockey extends ListActivity 
{
    ...
    public class RssLoadingTask extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            // TODO Auto-generated method stub
            myProgress = ProgressDialog.show(InsideHockey.this,
...
*/
    ...
    private void readRss()
    {
        ...
        try
        {
                    ...
                    || (wifi == NetworkInfo.State.CONNECTED || wifi == NetworkInfo.State.CONNECTING))
            {
                ...
                URL rssUrl = new URL(
                        "http://cds1-feed.yospace.com/001110588446");
            ...
            {
                File file = new File(
                        "/sdcard/Android/data/hnic/files/insidehockey.xml");
    ...
    protected void launchNewsViewer()
    {
        ...
        Intent b = new Intent(this, InsideHockey.class);
        startActivity(b);
    }
