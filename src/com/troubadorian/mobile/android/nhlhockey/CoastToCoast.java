...
public class CoastToCoast extends ListActivity
{
    ProgressDialog myProgress;

    public static final String TAG = "Coast to Coast";
    
    private static final String C2 = "Coast to Coast";
    ...
    public class RssLoadingTask extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            // TODO Auto-generated method stub
            myProgress = ProgressDialog.show(CoastToCoast.this,
...
/*        AppMeasurement s;
    ...
    private void readRss()
    {
        ...
        try
        {
                    ...
                    || (wifi == NetworkInfo.State.CONNECTED || wifi == NetworkInfo.State.CONNECTING))
            {
                ...
                URL rssUrl = new URL(
                        "http://cds1-feed.yospace.com/001110588334");
            ...
            {
                File file = new File(
                        "/sdcard/Android/data/hnic/files/coasttocoast.xml");
    ...
    protected void launchNewsViewer()
    {
        ...
        Intent b = new Intent(this, CoastToCoast.class);
        startActivity(b);
    }
