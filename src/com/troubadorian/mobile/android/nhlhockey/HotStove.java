...
public class HotStove extends ListActivity 
{
    ProgressDialog myProgress;

    public static final String TAG = "Hot Stove";
    
    private static final String C2 = "Hot Stove";
    ...
    public class RssLoadingTask extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            // TODO Auto-generated method stub
            myProgress = ProgressDialog.show(HotStove.this,
  ...
  /*      AdMarvelView adMarvelView = (AdMarvelView) findViewById(R.id.ad);
   ...
   /*     AppMeasurement s;
    ...
    private void readRss()
    {
        ...
        try
        {
                    ...
                    || (wifi == NetworkInfo.State.CONNECTED || wifi == NetworkInfo.State.CONNECTING))
            {
                ...
                URL rssUrl = new URL(
                        "http://cds1-feed.yospace.com/001110588342");
            ...
            {
                File file = new File(
                        "/sdcard/Android/data/hnic/files/hotstove.xml");
    ...
    protected void launchNewsViewer()
    {
        ...
        Intent b = new Intent(this, HotStove.class);
        startActivity(b);
    }
