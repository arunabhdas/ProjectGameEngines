...
public class TopFive extends ListActivity
{
    ProgressDialog myProgress;

    public static final String TAG = "Top Five";
    ...
    public class RssLoadingTask extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            // TODO Auto-generated method stub
            myProgress = ProgressDialog.show(TopFive.this,
    ...
    private void readRss()
    {
        ...
        try
        {
                    ...
                    || (wifi == NetworkInfo.State.CONNECTED || wifi == NetworkInfo.State.CONNECTING))
            {
                ...
                URL rssUrl = new URL(
                        "http://cds1-feed.yospace.com/001110786576");
            ...
            {
                File file = new File(
                        "/sdcard/Android/data/hnic/files/topfive.xml");
    ...
    protected void launchNewsViewer()
    {
        ...
        Intent b = new Intent(this, TopFive.class);
        startActivity(b);
    }
